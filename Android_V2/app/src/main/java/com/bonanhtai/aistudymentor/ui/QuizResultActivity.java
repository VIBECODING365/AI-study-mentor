...
public class QuizResultActivity extends AppCompatActivity {
    ...
    private void displayResults() {
        ...
        for (int i = 0; i < questions.size(); i++) {
            ...
            String cleanUAns = (uAns != null && !uAns.isEmpty()) ? uAns.substring(0, 1).trim() : "";
            String cleanCAns = (cAns != null && !cAns.isEmpty()) ? cAns.substring(0, 1).trim() : "";

            if (!cleanUAns.isEmpty() && cleanUAns.equalsIgnoreCase(cleanCAns)) {
                score++;
